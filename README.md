...
5. Не описанный, но очень важный момент. Не надо менять разрешения на каталог /etc. И пользователя и группу этого каталога не надо менять. Потом вернуть крайне сложно
